...
import './Header.css'
const Header = () => {
    const { user, logout, isLogIn, admin } = useAuth();

    const [navbarOpen, setNavbarOpen] = React.useState(false);
    return (
        <>
            <nav className="headersection top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg">
